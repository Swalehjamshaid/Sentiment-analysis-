...
async def ingest_reviews(
    ...
    for item in scraped_data:
        try:
            ...
            # 4. Duplicate check against Google ID
            ...
            logger.warning(f"Failed to process a review: {e}")
            continue
