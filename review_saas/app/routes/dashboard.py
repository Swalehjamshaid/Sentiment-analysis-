...
# ==========================================================
# REVIEW INTELLIGENCE DASHBOARD — 100% INTEGRATED
# ==========================================================
# COMPLETE BACKEND FOR FRONTEND WITH:
# - KPIs, Emotion Radar, Sentiment Trend, Rating Distribution
# - Latest 100 Reviews Table
...
async def chat_with_ai(
    ...
    try:
        ...
        system_prompt = f"""You are an expert Business Strategy Consultant specializing in customer review analysis.

COMPANY: {company.name}
Total Reviews: {analytics['metadata']['total_reviews']}
...
Provide concise, actionable advice (2-4 sentences). Focus on operational improvements."""
