...
def generate_ai_business_advice(data: Dict[str, Any]) -> str:
    ...
    Provide a professional summary of reputation and 3 actionable recommendations to improve customer loyalty.
    """
    try:
        ...
        return "Maintain service standards and focus on resolving staff-related friction points."
...
async def get_dashboard_insights(
    ...
    response = {
        ...
        "kpis": {
            ...
            "benchmark": {"your_avg": round(avg_rating, 2), "category_avg": round(category_avg, 2)}
        },
        "visualizations": {
