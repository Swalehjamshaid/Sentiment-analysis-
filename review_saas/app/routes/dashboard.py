...
# AI / ML - Using try-except to ensure the router loads even if heavy libs are missing
...
try:
    ...
    embedder = None
    logging.warning("sentence-transformers not found. Clustering will be disabled.")
...
def detect_spam(text: str) -> bool:
    ...
    if text.lower().count("bad") > 5: return True
    return False
...
def generate_ai_summary(data: Dict[str, Any]) -> str:
    ...
    return "Optimize staff responsiveness and scale positive customer experiences."
...
async def get_dashboard_insights(
    ...
    spam_flags, sentiments, texts, emotions = [], [], [], []
    ...
    # Semantic Clustering with safety check
    clusters = []
    ...
    return {
        "metadata": {"company": company.name, "total_reviews": total},
        "kpis": {
        ...
        "visualizations": {
            ...
            "sentiment_trend": [
                ...
                for w, d in sorted(weekly_trend.items()) # Ensures chronological order
            ],
