...
# Import the shared Declarative Base from db.py
from app.core.db import Base

# ---------------------------------------------------------
# SCHEMA VERSION (USED BY STARTUP AUTO-RESET LOGIC)
# ---------------------------------------------------------
...
class Review(Base):
    ...
    google_review_time: Mapped[Optional[datetime]] = mapped_column(
        DateTime(timezone=True)
    )
...
# ---------------------------------------------------------
# CONFIG TABLE (SCHEMA VERSION, FLAGS, ETC.)
# ---------------------------------------------------------
class Config(Base):
