...
# --- 1. THE CIRCULAR FIX ---
# We import Base directly from app.core.db. 
# For this to work, app/core/db.py MUST define Base at the top 
# and NOT import models at the top level.
from app.core.db import Base

# Stegman Versioning: Incremented to trigger a fresh DB state on Railway
