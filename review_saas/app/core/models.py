...
# ✅ THE CRITICAL FIX: Import the existing Base from db.py
# This ensures alignment between your engine and your models.
from app.core.db import Base

# Schema version for migration control
...
class VerificationToken(Base):
    ...
    token: Mapped[str] = mapped_column(String(128), default=lambda: secrets.token_urlsafe(32), unique=True, index=True)
