...
class FastGoogleScraper:
    ...
    async def get_reviews(self, data_id: str, limit: int = 1000) -> List[Dict[str, Any]]:
        ...
        :param limit: Number of reviews to fetch. Default 1000.
        """
        ...
        # !3i{limit} -> Result count (Fetches 1000+ at once)
        ...
        # Increase timeout to 30.0 for large data batches
        async with httpx.AsyncClient(headers=self.headers, timeout=30.0, follow_redirects=True) as client:
            try:
                ...
                # Google prefixes JSON with security characters )]}' to prevent XSSI
                ...
                if not data or not isinstance(data, list):
                    logger.warning(f"Malformed response for data_id: {data_id}")
                    return []

                # Find the review list within Google's nested response
                raw_reviews = []
                for item in data:
                ...
                for r in raw_reviews:
                    try:
                        ...
                        review_item = {
                            ...
                            # Millisecond timestamp conversion to UTC ISO format
