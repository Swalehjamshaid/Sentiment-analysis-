...
async def fetch_reviews(place_id: str, limit: int = 1000) -> List[Dict[str, Any]]:
    """
    Lightweight Stealth Scraper: 100% Python Library based.
    ...
    # Using an Async Client for high performance
    async with httpx.AsyncClient(headers=headers, timeout=30.0, follow_redirects=True) as client:
        while len(all_reviews) < limit:
            # Internal Google Search Review Endpoint
            # This format is highly resilient against 400 Bad Request errors
