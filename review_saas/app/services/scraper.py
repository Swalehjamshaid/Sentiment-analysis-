...
"PROXY_SERVER",
"[http://gw.dataimpulse.com:823](http://gw.dataimpulse.com:823)"
)
...
def build_google_maps_url(place_id: str):
...
try:
    ...
    review_date = safe_datetime(review_date)
        ...
        for block in review_blocks[:target_limit]:
            ...
            try:
                ...
                review = {
                    ...
                    "text": review_text,
                    "stars": rating,
                    "publishedAtDate": datetime.utcnow().isoformat()
                }
